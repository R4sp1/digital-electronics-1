...
namespace eval ::optrace {
  variable script "F:/digital-electronics-1/labs/04-segment/display/display.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet F:/digital-electronics-1/labs/04-segment/display/display.runs/synth_1/top.dcp
